...
{
  "\"end of file\"", "error", "\"invalid token\"", "LET", "REC", "IN",
  "SEMICOLON", "PIPE", "ARROW", "MATCH", "WITH", "EQUAL", "PLUS", "MINUS",
  "LESS", "$accept", "program", "statements", "statement", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* statement: LET  */
#line 39 "parser.y"
        { printf("LET\n"); }
#line 1134 "parser.tab.c"
    break;

  case 6: /* statement: REC  */
#line 40 "parser.y"
         { printf("REC\n"); }
...
#line 1152 "parser.tab.c"
  ...
  case 9: /* statement: PIPE  */
#line 43 "parser.y"
         { printf("PIPE\n"); }
#line 1158 "parser.tab.c"
    break;

  case 10: /* statement: ARROW  */
#line 44 "parser.y"
          { printf("ARROW\n"); }
#line 1164 "parser.tab.c"
    break;

  case 11: /* statement: MATCH  */
#line 45 "parser.y"
          { printf("MATCH\n"); }
#line 1170 "parser.tab.c"
    break;

  case 12: /* statement: WITH  */
#line 46 "parser.y"
         { printf("WITH\n"); }
#line 1176 "parser.tab.c"
    break;

  case 13: /* statement: EQUAL  */
#line 47 "parser.y"
          { printf("EQUAL\n"); }
#line 1182 "parser.tab.c"
    break;

  case 14: /* statement: PLUS  */
#line 48 "parser.y"
         { printf("PLUS\n"); }
#line 1188 "parser.tab.c"
    break;

  case 15: /* statement: MINUS  */
#line 49 "parser.y"
          { printf("MINUS\n"); }
#line 1194 "parser.tab.c"
    break;

  case 16: /* statement: LESS  */
#line 50 "parser.y"
         { printf("LESS\n"); }
